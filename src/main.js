...
const getMainNavTemplate = () => `<nav class="main-navigation">
...
const getStatisticTemplate = () => `<section class="statistic">
...
const getProfileHeaderTemplate = () => `<section class="header__profile profile">
    <p class="profile__rating">Movie Buff</p>
    <img class="profile__avatar" src="images/bitmap@2x.png" alt="Avatar" width="35" height="35">
  </section>`;

const getFilms = () => `<section class="films">
...
const getFilmCardsTemplate = () => `<article class="film-card">
...
const getFilmDetalisTemplate = () => `<section class="film-details">
...
const getButtonShowMoreTemplate = () => `<button class="films-list__show-more">Show more</button>`;
const getExtraFilmList = () => `<section class="films-list--extra">
